...
This is the internal scope note for what the GLM binding exposes today, what
remains reasonable to add later, and what is intentionally outside the first
public surface.

The public-facing mapping document lives in `docs/api-mapping.md`. This section
is the authoritative internal inventory.
